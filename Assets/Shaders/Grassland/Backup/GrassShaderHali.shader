    ...
    Properties
    {
        ...
        [HDR]_WindColor("Wind color", Color) = (1,1,1,1)
            ...
            [HDR]_TranslucentColor("Translucent color", Color) = (1,1,1,1)
                ...
                _GrassTrampleOffsetAmount("Grass trample offset amount", Range(0, 100)) = 0.2
    }
    SubShader
    {
